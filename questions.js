const questions = [
    ...
    { text: "技術的な正論を言うと、現場や上司から煙たがられる雰囲気がある。", stage: "社内政治", category: "val", inverted: true },
    { text: "昇進には技術力よりも、誰に気に入られるかが重要だと思う。", stage: "社内政治", category: "val", inverted: true },
    ...
    { text: "トラブル時、原因究明より「誰が責任を取るか」の話が先に出る。", stage: "社内政治", category: "val", inverted: true },
    ...
    { text: "工具や計測機器の「クセ」を、自分だけが把握している状態にある。", stage: "現場のリアル", category: "act" },
    ...
    { text: "「できない」と言うよりも、とりあえず「検討します」と逃げる術を覚えた。", stage: "社内政治", category: "act", inverted: true },
    { text: "現場の騒音や粉塵の中でも、五感で異常を察知できる自信がある。", stage: "現場のリアル", category: "act" },
    { text: "休日でも、プラントの稼働状況が気になってスマホを見てしまう。", stage: "現場のリアル", category: "act" },

    // pri: Quality(100) vs Delivery(0)
    { text: "理論的な最適解よりも、納期に間に合う「泥臭い解決」を優先する。", stage: "現場のリアル", category: "pri", inverted: true },
    { text: "安全よりも効率が優先される瞬間を、見て見ぬふりをしたことがある。", stage: "現場のリアル", category: "pri", inverted: true },
    ...
    { text: "責任だけが増えて、裁量や給与が見合っていないと感じる。", stage: "生存リスク", category: "pri", inverted: true },
    { text: "家族や友人よりも、現場のトラブル対応を優先するのが常識になっている。", stage: "生存リスク", category: "pri", inverted: true },
    ...
    { text: "朝、会社（現場）に行くのが、肉体的にではなく「心理的に」辛い日がある。", stage: "生存リスク", category: "mnd", inverted: true },
    { text: "今のスキルが、他社や他業界で通用するイメージが全く湧かない。", stage: "生存リスク", category: "mnd", inverted: true },
    { text: "正直に言うと、今すぐすべてを投げ出して逃げ出したい瞬間がある。", stage: "生存リスク", category: "mnd", inverted: true }
];